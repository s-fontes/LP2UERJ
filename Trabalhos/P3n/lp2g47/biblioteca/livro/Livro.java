package P3n.lp2g47.biblioteca.livro;

import P3n.lp2g47.biblioteca.emprestimo.EmprestaPara;
import P3n.lp2g47.biblioteca.excp.CopiaNaoDisponivelEx;
import P3n.lp2g47.biblioteca.excp.NenhumaCopiaEmprestadaEx;
import P3n.lp2g47.biblioteca.utils.Categoria;
...
public class Livro {
    ...
    public void empesta() throws CopiaNaoDisponivelEx {
        if (copias > emprestados){
            emprestados++;
        } else {
            throw new CopiaNaoDisponivelEx("Livro indisponível");
        }
    }
